...
MEDIA_CAPTIONS = {
    ...
    (4, "photo", 1): "Lunch before the chocolate tour",
    (4, "video", 1): "From cacao pod to chocolate",
    (4, "video", 2): "The first chocolate taste test",
    (4, "video", 3): "Taking a turn at the cacao grinder",
    (4, "video", 4): "Pressing fresh cacao beans",
    (4, "photo", 2): "Hot chocolate after the tour",
    ...
    (7, "video", 4): "Low tide at Corcovado",
    (7, "photo", 21): "A wave from the tidal flats",
    (7, "video", 5): "Family selfie on the flats",
    (7, "photo", 22): "One last selfie before the boat",
